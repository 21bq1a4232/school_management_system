...
urlpatterns = [
    ...
    path('add_fees/', HodViews.add_fees, name='add_fees'),
    path('edit_fees/<int:pk>/', HodViews.edit_fees, name='edit_fees'),
    path('delete_fees/<int:pk>/', HodViews.delete_fees, name='delete_fees'),
    path('hod/search_students/', HodViews.hod_search_students, name='hod_search_students'),
    ...
    path('edit_timetable/<int:pk>/', HodViews.edit_timetable, name='edit_timetable'),
    path('delete_timetable/<int:pk>/', HodViews.delete_timetable, name='delete_timetable'),
    path('staff/timetable/', StaffViews.staff_view_timetable, name='staff_view_timetable'),
